...
public class stripePayment {
    ...
    private const string USER_AGENT = "exoSCADA";
    private const string STRIPE_URI = "https://api.stripe.com/v1/tokens";
    private const string STRIPE_AUTH = "";
    private const string STRIPE_REQUEST_USD = "email=%s"
                            + "&payment_user_agent=%s&amount=%s&card[number]=%s"
                            + "&card[cvc]=%s&card[exp_month]=%s&card[exp_year]=%s"
                            + "&key=%s"
                            + "&currency=USD";
    private const string STRIPE_REQUEST_BTC = "email=%s"
                            + "&payment_user_agent=%s&amount=%s&card[number]=%s"
                            + "&card[cvc]=%s&card[exp_month]=%s&card[exp_year]=%s"
                            + "&key=%s"
                            + "&currency=USD";
    ...
    // private exoSCADA.someObject card_number_entry;
    //  private exoSCADA
